...
import { InstructorForumsComponent } from './instructor-forums/instructor-forums.component';
import { InstructorPostComponent } from './instructor-post/instructor-post.component';
...
const routes: Routes = [
  {
    ...
    { path: 'instructor-editTest/:id', component: TestFormComponent },
      ...
      {path: 'instructor', component: InstructorForumsComponent, canActivate: [AuthGuard]},
            {path: 'instructor-forums/:id', component: InstructorPostComponent, canActivate: [AuthGuard]},
      {
