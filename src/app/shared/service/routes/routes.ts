export class routes {
  ...
  public static get moderator_forums(): string {
    return this.moderator + 'moderator';
  }

  public static get moderator_forums_by_id(): string {
    return this.moderator + 'moderator/:id';
  }
...
public static get EditTest(): string {
  ...
  public static get instructor_forums(): string {
    return this.instructor + 'instructor';
  }

  public static get instructor_forums_by_id(): string {
    return this.instructor + 'instructor/:id';
  }
...
public static get CreateReclamation(): string {
  ...
  public static get students_forums(): string {
    return this.students + 'student-forums';
  }

  public static get students_forums_by_id(): string {
    return this.students + 'student-forums/:id';
  }
