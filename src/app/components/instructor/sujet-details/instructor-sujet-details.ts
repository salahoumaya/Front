...
@Component({
  selector: 'instructor-sujet-details',
  templateUrl: './instructor-sujet-details.html',
  styleUrls: ['./instructor-sujet-details.scss']
})
export class InstructorSujetDetails implements OnInit {
  sujetPfe!: SujetPfe;
