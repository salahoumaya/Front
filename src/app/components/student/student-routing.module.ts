...
import { StudentForumsComponent } from './student-forums/student-forums.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'student-forums', component: StudentForumsComponent, canActivate: [AuthGuard]},
      {path: 'student-forums/:id', component: StudentPostComponent, canActivate: [AuthGuard]},
      {
        path: 'settings',
        loadChildren: () =>
