export class routes {
  ...
  public static get dashboard_admin(): string {
    return this.admin + 'admin-dashboard';
  }

  public static get admin_chat(): string {
    return this.admin + 'admin-chat';
  }

  public static get admin_deposit_dashboard(): string {
    return this.admin + 'deposit-instructor-dashboard';
  }

  public static get admin_list(): string {
    return this.admin + 'admin-view/admin-list';
  }

  public static get admin_grid(): string {
    return this.admin + 'admin-view/admin-grid';
  }

  public static get list_sujet_admin(): string {
    return this.admin + 'list-sujet';
  }

  public static get admin_reviews(): string {
    return this.admin + 'admin-reviews';
  }

  public static get admin_student_grid(): string {
    return this.admin + 'admin-student-grid';
  }

  public static get admin_student_list(): string {
    return this.admin + 'admin-student-list';
  }

  public static get admin_earnings(): string {
    return this.admin + 'admin-earnings';
  }

  public static get admin_orders(): string {
    return this.admin + 'admin-orders';
  }

  public static get admin_payouts(): string {
    return this.admin + 'admin-payouts';
  }

  public static get admin_new_tickets(): string {
    return this.admin + 'admin-new-tickets';
  }

  public static get admin_tickets(): string {
    return this.admin + 'admin-tickets';
  }

  public static get admin_edit_profile(): string {
    return this.admin + 'admin-edit-profile';
  }

  public static get admin_security(): string {
    return this.admin + 'admin-security';
  }

  public static get admin_social_profiles(): string {
    return this.admin + 'admin-social-profiles';
  }

  public static get admin_notification(): string {
    return this.admin + 'admin-notification';
  }

  public static get admin_profile_privacy(): string {
    return this.admin + 'admin-profile-privacy';
  }

  public static get admin_delete_profile(): string {
    return this.admin + 'admin-delete-profile';
  }

  public static get admin_linked_account(): string {
    return this.admin + 'admin-linked-account';
  }

  public static get admin_profile(): string {
    return this.admin + 'admin-profile';
  }

  public static get admin_withdrawal_admin(): string {
    return this.admin + 'withdrawal-admin';
  }

  public static get admin_deposit_admin(): string {
    return this.admin + 'deposit-admin';
  }

  public static get admin_transactions_admin(): string {
    return this.admin + 'transactions-admin';
  }

  public static get adminAnnouncements(): string {
    return this.admin + 'admin-announcements';
  }

  public static get adminAssignment(): string {
    return this.admin + 'admin-assignment';
  }

  public static get adminWishlist(): string {
    return this.admin + 'admin-wishlist';
  }

  public static get adminChangePassword(): string {
    return this.admin + 'settings/admin-change-password';
  }

  public static get adminSettings(): string {
    return this.admin + 'settings/admin-settings';
  }

  public static get adminwithdraw(): string {
    return this.admin + 'admin-withdraw';
  }
  ...
  public static get adminQA(): string {
    return this.admin + 'admin-qa';
  }

  public static get adminQuiz(): string {
    return this.admin + 'admin-quiz';
  }

  public static get adminQuizAttempts(): string {
    return this.admin + 'admin-quiz-attempts';
  }

  public static get adminQuizAttemptsDetails(): string {
    return this.admin + 'admin-quiz-attempts-details';
  }

  public static get adminSettingNotifications(): string {
    return this.admin + 'settings/admin-setting-notifications';
  }

  public static get adminReferral(): string {
    return this.admin + 'admin-referral';
  }

  public static get adminDeleteAccount(): string {
    return this.admin + 'settings/admin-delete-account';
  }

  public static get adminCourse(): string {
    return this.admin + 'admin-course';
  }

  public static get adminDetails(): string {
    return this.admin + 'admin-details';
  }

  public static get adminEnrolledCourse(): string {
    return this.admin + 'admin-enrolled-course';
  }

  public static get adminQuizDetails(): string {
    return this.admin + 'admin-quiz-details';
  }

  public static get adminSettingWithdraw(): string {
    return this.admin + 'settings/admin-setting-withdraw';
  }
